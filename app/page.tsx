    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900">Supabase Keeper</span>
            </div>
            <div className="flex items-center gap-4">
              <a href="https://github.com/AayushPaigwar/supabase-keeper" target="_blank" rel="noopener noreferrer">
                <div className="inline-block px-3 py-1 bg-gray-50 rounded-full text-xs font-medium text-gray-700 hover:bg-gray-100 transition-colors">
              ...
              <div className="flex gap-3">
                ...
                <Link
                  href="/signup"
                  className="px-6 py-2 text-sm font-medium text-white bg-[#016239] rounded-lg hover:bg-[#014d2d] transition-colors"
                >
                  Sign Up
                </Link>
              </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Link
              href="/signup"
              className="px-8 py-4 text-lg font-medium text-white bg-[#016239] rounded-lg hover:bg-[#014d2d] transition-colors inline-flex items-center gap-2"
            >
              Get Started Free →
            </Link>
            <button className="px-8 py-4 text-lg font-medium text-gray-700 bg-white border-2 border-gray-200 rounded-lg hover:border-gray-300 transition-colors">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Supabase Keeper?</h2>
            <p className="text-gray-600">Keep your Supabase free tier projects active without manual intervention</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Automated Pings</h3>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Easy Dashboard</h3>
              <p className="text-gray-600">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#016239] text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                1
              </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Connect your Supabase project URLs and keys</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#016239] text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                3
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Relax</h3>
              <p className="text-gray-600">We'll keep your projects alive automatically</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#016239] rounded-3xl p-12 text-center text-white">
            <h2 className="text-3xl font-bold mb-4">Ready to Keep Your Projects Alive?</h2>
            <p className="text-lg mb-8 text-green-100">
              Join developers who never worry about inactive Supabase projects
            </p>
            <Link
              href="/signup"
              className="inline-block px-8 py-4 text-lg font-medium text-[#016239] bg-white rounded-lg hover:bg-gray-100 transition-colors"
            >
              Get Started Free →
            </Link>
          </div>
